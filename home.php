            ...
            <ul class="navbar-nav ms-auto mb-2 mb-md-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="dropdown"
                  ...
                  <li><a class="dropdown-item text-light" href="profile.php"><i
                        class="bi bi-person-circle me-2"></i>Thông tin cá nhân</a></li>
                  <li>
                    <hr class="dropdown-divider">
                  </li>
                  ...
                  <li><a class="dropdown-item text-light" href="login.php"><i
                        class="bi bi-box-arrow-right me-3"></i>Đăng xuất</a></li>
                </ul>
              </li>
            </ul>
          </div>
